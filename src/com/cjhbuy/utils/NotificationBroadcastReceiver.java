...
public class NotificationBroadcastReceiver extends BroadcastReceiver {
	...
	private void gotoSingleChatActivity(Context context, Intent intent) {
		...
		startActivityIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		startActivityIntent.putExtra(Constants.MEMBER_ID, intent.getStringExtra(Constants.MEMBER_ID));//卖家手机号
		startActivityIntent.putExtra("seller_user_id", intent.getStringExtra("seller_user_id"));//卖家ID
		context.startActivity(startActivityIntent);
	}
}
